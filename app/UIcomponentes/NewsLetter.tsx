...
const NewsLetter = () => {
    return (
        <div className='w-full flex justify-center  items-center'>
            ...
            <span className='absolute mt-24 '><input placeholder='Enter Your Email' type='email' className='p-2 border-2  rounded-md ' /> <button className='border text-white bg-red-400 p-2 hover:bg-red-500 transition-colors'>Subscribe</button> </span>
