  ...
  return (
    <>
      <main className='bg-gray-50' >
        ...
        <header className='w-full mt-6 p-46 rounded-lg border-b-4 border-green-700 pb-4'>
          <Image src={Header} alt='header' placeholder='blur' />
          <button></button>
        </header>

        <div className='fixed max-w-[50%] mx-auto p-6 '><Separator /></div>
        <div id='section1' className=' pt-6 text-center mt-11  mx-auto'>
        ...
        <div id='scrollToSection' className='relative  rounded-lg pt-6 mt-6 w-full h-full mb-6'>
          ...
          <div className='relative z-10 w-full h-full p-6 mt-11'>
            <Image className='absolute ' placeholder='blur' src={template} alt='bg' />
            <Reservation />
          </div>
        </div>
        <div id='section3' className='max-w-[50%] mx-auto p-2 '>
