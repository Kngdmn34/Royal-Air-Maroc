    ...
    return (
        ...
        <footer className="  bg-gray-900  dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl">
                ...
                <div className="px-4 py-6 bg-gradient-to-r from-red-500 to-emerald-800 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm drop-shadow-sm text-white dark:text-gray-300 sm:text-center">© 2023 <a href="/">Royal Air Maroc</a>. All Rights Reserved.
                    </span>
